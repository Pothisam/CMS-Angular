import { Component, OnInit, ElementRef , Renderer2 ,RendererFactory2, AfterViewInit } from '@angular/core';
...
export class ErrorTagComponent implements OnInit {
  ...
  constructor(private badgeService: BadgeService,private el: ElementRef,private rendererFactory: RendererFactory2) {
