...
import {
  ICourseResponse,
  IAddCourseRequest,
} from 'src/app/Modules/CMS/course/course';
        ...
        buttongroup: [
          {
            ...
            click: [
              'delete|sysid|courseNameBD|/Course/DeleteCourse|sysId|Are sure you want to Delete Course: <span class="text-danger">{{0}}</span>|Note: Deleting Course Affect Section and Student Details',
            ],
          },
        ],
